    ...
    <section className="px-32 py-16">
      ...
      <div className="flex flex-col justify-between gap-8 xl:flex-row ">
        <div className=" flex shrink grow-[1.5] basis-0 flex-col gap-4">
          <div className="flex items-center justify-between bg-[#d5d5d8] px-8 tracking-tighter text-[#212121]">
          ...
          <div className="flex flex-col items-center justify-center bg-[#212121] px-[2rem] pb-[2rem] pt-[3rem] text-white">
            ...
            <button className=" mt-1 rounded-lg border-0 bg-[#474747] px-10 py-2 text-lg font-bold leading-5 tracking-[0.25em] text-white">DINEWEEKENDSALE</button>
          </div>
        </div>
        <div className="flex items-center justify-between gap-4 shrink grow basis-0">
          <div className="flex flex-col items-center justify-between bg-[#efe1c7] pt-6 h-full w-full">
          ...
          <div className="flex flex-col items-center justify-between bg-[#d7d7d9] pt-6 h-full w-full">
            <div className="w-full ml-10">
