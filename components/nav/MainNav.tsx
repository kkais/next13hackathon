...
const MainNav: FC<{ cartItems: number }> = ({ cartItems }) => {
		...
		z"
                ...
                <Link href="/cart">
                    <Button className="relative hidden h-auto rounded-full border-0 bg-[#f1f1f1] hover:bg-gray-300 p-3 text-black transition duration-300 delay-0 ease-linear hover:scale-110 hover:transform lg:flex">
                        ...
                        <span className=" absolute right-[5px] top-0 h-[18px] w-[18px] rounded-full bg-[#f02d34] text-center text-xs font-semibold text-[#eee]">{cartItems}</span>
                    </Button>
                </Link>
